package com.silvia.controlbox.ui;
...
public class BottomBar extends View {
     ...
     * @return
     */
    public BottomBar addItemWithNoIcon(Class fragmentClass, String title){
        fragmentClassList.add(fragmentClass);
        titleList.add(title);
        return this;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        try {
            ...
            if (itemCount != 0) {
                ...
                if (iconBitmapAfterList.size() == 0) {

                } else {
                    Log.e("iconBitmapAfterList", iconBitmapAfterList.size() + "");
                    for (int i = 0; i < itemCount; i++) {
                        Bitmap bitmap = null;
